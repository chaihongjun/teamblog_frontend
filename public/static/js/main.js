      ...
      define("chicago", function() {
        return (
          (b.load = function(a, c, d, e) {
            var f = a.split(","),
              g = [],
              h = (e.config && e.config.chicago && e.config.chicago.base
  ...
  (a.$win = a.$(b)),
    ...
    (a.events.resizeend = {
      ...
      setup: function() {
        var b,
          c = arguments,
          d = { delay: a.$.event.special.resizeend.defaults.delay };
        a.utils.is.fn(c[0])
          ? (b = c[0])
...
(function($) {
  ...
  $("body").scrollTo = function(name, add, speed) {
    if (!speed) speed = 300;
    if (!name) {
      $("html,body").animate(
        {
  ...
  $("body").is_name = function(str) {
    return /.{2,12}$/.test(str);
  };
  $("body").is_url = function(str) {
    return /^((http|https)\:\/\/)([a-z0-9-]{1,}.)?[a-z0-9-]{2,}.([a-z0-9-]{1,}.)?[a-z0-9]{2,}$/.test(
      str
    );
  };
  $("body").is_qq = function(str) {
    return /^[1-9]\d{4,13}$/.test(str);
  };
  $("body").is_mail = function(str) {
   ...
   */
  // $('body') = $("body");
  // $("body").is_signin = $('body').hasClass("logged-in") ? true : false;
  ...
  var _fix =
    $("body").hasClass("nav_fixed") && !$("body").hasClass("page-template-navs")
      ? true
      : false;
  ...
  if (_wid > 1024 && _sidebar.length) {
    var h1 = 15,
      h2 = 30;
    var rollFirst = _sidebar.find(
      ".widget:eq(" + ($("body").roll[0] - 1) + ")"
    );
    ...
    rollFirst.on("affix-top.bs.affix", function() {
      ...
      for (var i = 1; i < $("body").roll.length; i++) {
        var item = $("body").roll[i] - 1;
    ...
    rollFirst.on("affix.bs.affix", function() {
      rollFirst.css({
        top: $("body").hasClass("nav-fixed") ? h1 + 63 : h1,
      });
